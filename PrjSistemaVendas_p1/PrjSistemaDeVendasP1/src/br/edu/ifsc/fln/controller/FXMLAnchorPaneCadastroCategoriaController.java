...
public class FXMLAnchorPaneCadastroCategoriaController implements Initializable {
    ...
    public void handleBtAlterar() throws IOException {
        Categoria categoria
                = tableViewCategorias.getSelectionModel().getSelectedItem();
        if (categoria != null) {
            boolean btConfirmarClicked
                    = showFXMLAnchorPaneCadastroCategoriaDialog(categoria);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tableViewCategorias.getSelectionModel().selectedItemProperty().
                addListener((observable, oldValue, newValue)
                        -> selecionarItemTableViewCategorias(newValue));

    }

    public void carregarTableViewCategoria() {
        tableColumnCategoriasDescricao.setCellValueFactory(
    ...
    public void selecionarItemTableViewCategorias(Categoria categoria) {
        if (categoria != null) {
            lbId.setText(String.valueOf(categoria.getId()));
            lbDescricao.setText(categoria.getDescricao());
        } else {
            lbId.setText("");
            lbDescricao.setText("");
        }
