...
//        switch (codigo) {
//            case 1, 2, 3: JOptionPane.showMessageDialog(null, "Alimento não perecível."); break;
//            case 4, 5: JOptionPane.showMessageDialog(null, "Alimento perecível."); break;
//            case 6: JOptionPane.showMessageDialog(null, "Vestuário."); break;
//            case 7: JOptionPane.showMessageDialog(null, "Higiene pessoal."); break;
...
//        }
        ...
        switch (codigo) {
            case 1, 2, 3 -> JOptionPane.showMessageDialog(null, "Alimento não perecível.");
            case 4, 5 -> JOptionPane.showMessageDialog(null, "Alimento perecível.");
            case 6 -> JOptionPane.showMessageDialog(null, "Vestuário.");
